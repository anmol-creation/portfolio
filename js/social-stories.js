document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadGallery() {
        try {
            ...
            const response = await fetch('data/social-stories.json');
    ...
    function renderGallery(resources) {
        ...
        if (!resources || resources.length === 0) {
            galleryGrid.innerHTML = '<div class="loading-state">No stories found in folder.</div>';
            return;
        }
    ...
    function renderCategorized(resources) {
        ...
        if (!resources || resources.length === 0) {
            categorizedView.innerHTML = '<div class="loading-state">No stories found in folder.</div>';
            return;
        }
