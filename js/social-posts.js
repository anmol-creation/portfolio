document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderGallery(resources) {
        ...
        if (!resources || resources.length === 0) {
            galleryGrid.innerHTML = '<div class="loading-state">No posts found in folder.</div>';
            return;
        }
    ...
    function renderCategorized(resources) {
        ...
        if (!resources || resources.length === 0) {
            categorizedView.innerHTML = '<div class="loading-state">No posts found in folder.</div>';
            return;
        }
