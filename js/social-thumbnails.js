document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadGallery() {
        try {
            ...
            const response = await fetch('data/social-thumbnails.json');
    ...
    function renderGallery(resources) {
        ...
        if (!resources || resources.length === 0) {
            galleryGrid.innerHTML = '<div class="loading-state">No thumbnails found in folder.</div>';
            return;
        }
    ...
    function renderCategorized(resources) {
        ...
        if (!resources || resources.length === 0) {
            categorizedView.innerHTML = '<div class="loading-state">No thumbnails found in folder.</div>';
            return;
        }
        ...
        const dummyTags = ['Close-up', 'Black & White', 'Fashion', 'Candid'];
